...
const ResourceComponent = props => {
  var _resource, _resource2, _resource3;
...
var _default = async ({
  ...
  try {
    ...
    const Plan = ({
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_resourceProvider.ResourceProvider, {
    ...
    const RecipeInterpreter = () => {
      ...
      const Error = ({
        ...
        if (state && state.context && state.context.error) {
          return /*#__PURE__*/React.createElement(_ink.Text, {
            red: true
